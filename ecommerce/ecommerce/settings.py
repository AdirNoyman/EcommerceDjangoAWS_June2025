...
SECRET_KEY = "django-insecure-om*(#4f=z2bv$^v*312z-wo)=sz6qzn*rr3v@q(2nzdmo3x+bf"
...
INSTALLED_APPS = [
    ...
    'store',  # Django app named 'store'
    'cart',   # Django app named 'cart'
]
...
MEDIA_URL = "/media/"
MEDIA_ROOT = BASE_DIR / "static/media"  # Directory for media files uploaded by users
